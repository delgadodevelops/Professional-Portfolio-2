  ...
  return (
    <nav className="flex items-center justify-between p-4 text-nav">
      ...
      <div className="flex space-x-14">
        <Link to="/about" className="text-nav .text-white:hover relative">
          
          About
          <span className="underline-animation"></span>
        </Link>
        <Link to="/projects" className="text-nav .text-white:hover relative">
          Projects
          <span className="underline-animation"></span>
        </Link>
        <Link to="/contact" className="text-nav .text-white:hover relative">
          Contact
          <span className="underline-animation"></span>
        </Link>
      </div>
